...
1. [Proyectos Principales](./projects/)
   Herraamientas funcionales con un enfoque de resolución de problemas reales.
2. [Ruta de aprendizaje](./learning-path/)
   Laboratorios y ejercicios que demuestran mi evolución técnica.
   * **Python Essentials:** Manejo de datos, estructuras y peticiones.
   * **Bash Scriptng:** Automatización de tareas en Linux.
   * **Network Labs:** Scripts de interacción con protocolos de red.
   ...
   ## Notas de versión
   * **Marzo 2026:** Creación de repositorio y estructuración de carpetas.
